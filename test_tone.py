...
# from watson_developer_cloud import IAMTokenManager, DiscoveryV1
...
# text = {"text" : "Virginia vs. Auburn score: Live Final Four updates, 2019 NCAA Tournament highlights, stream, TV info - CBS Sports"}

# iam_token_manager = IAMTokenManager(iam_apikey=IBM_KEY)
# token = iam_token_manager.get_token()

tone_analyzer = ToneAnalyzerV3(
    version=IBM_VERSION,
    iam_apikey=IBM_KEY,
    url=IBM_URL + endpoint
)

# discovery = DiscoveryV1(version=IBM_VERSION, 
#                         url=IBM_URL,
...
tone_analysis = tone_analyzer.tone(tone_input={"text":"hi you suck"},
                                   content_type='application/json').get_result()
print(json.dumps(tone_analysis.get_result(), indent=2))
